      ...
      <section style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: "18px", lineHeight: "1.8", color: "#516174" }}>
            PixelMint Tools offers free image tools for creators, bloggers, Etsy sellers, small businesses, and digital content makers.
          </p>

          <p style={{ fontSize: "18px", lineHeight: "1.8", color: "#516174" }}>
            Our goal is to make simple image editing tasks faster and easier online.
          </p>
        </div>
      </section>
    </main>
